...
build_image:
	...
	docker-compose build --build-arg PROJECT_NAME=link-generator
...
run_local: clean build_image
	ENVIRONMENT=${ENV} AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY} AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID} AWS_SESSION_TOKEN=${AWS_SESSION_TOKEN} docker-compose up
